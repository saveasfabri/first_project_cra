...
const TaskCheckpoints=()=> {
  ...
  return (
    <div className="TaskCheckpoints">
      ...
      <p className="textTask"> <CheckBoxOutlined className='check'/> Al contador de clics que desarrollamos hoy, agregarle una función llamada decrease que reste la cantidad de clics del estado. Debe renderizar números negativos inclusive.</p>
